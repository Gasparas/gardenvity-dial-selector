jQuery(document).ready(function($) {
  ...
  jQuery(document).on('click', '.leds_checkboxes', function(e) {
    ...
    if (!hydroJetsObj.eq(0).hasClass("tc-active")) {
    ...
    } else if ($(this).parent('label').parent('.tc-active').length &&
      !ledParentObj.children('.tc-active:nth-child(1)').length &&
      $('.air_jets_checkboxes-ul li:first-child').hasClass('tc-active')) {
      activeSlots[1] = '0';
      $('.conf-service').hide();
      $('.conf-filter-service-menu').children('div').eq(0).hide();
      ...
      !ledParentObj.children('.tc-active:nth-child(2)').length &&
      $('.air_jets_checkboxes-ul li:first-child').hasClass('tc-active')) {
      activeSlots[1] = '0';
      $('.conf-service').hide();
      $('.conf-filter-service-menu').children('div').eq(0).hide();
  ...
  $('.insert-color-div ul li').eq(0).change(function() {
    ...
    img.src = "/wp-content/uploads/dial-selector/dial-selector-uk-base-white.jpg";
  });
  $('.insert-color-div ul li').eq(1).change(function() {
    const img = document.querySelector('.conf-base');
    img.src = "/wp-content/uploads/dial-selector/dial-selector-uk-base-grey.jpg";
  });
  $('.insert-color-div ul li').eq(2).change(function() {
    const img = document.querySelector('.conf-base');
    img.src = "/wp-content/uploads/dial-selector/dial-selector-uk-base-gold.jpg";
  });
  $('.insert-color-div ul li').eq(3).change(function() {
    const img = document.querySelector('.conf-base');
    img.src = "/wp-content/uploads/dial-selector/dial-selector-uk-base-blue.jpg";
  });
