...
jQuery(document).ready(function($) {
  ...
  airJetsImg.src = "/wp-content/uploads/dial-selector/dial-selector-air-jets-" + 20 + ".svg";
  // Hydro Jets 20
  ...
  // LEDs
  const ledsImg10 = document.querySelector('.conf-led-' + 10);
  ledsImg10.src = "/wp-content/uploads/dial-selector/dial-selector-led-" + 10 + ".svg";
  const ledsImg1 = document.querySelector('.conf-led-' + 1);
  ledsImg1.src = "/wp-content/uploads/dial-selector/dial-selector-led-" + 1 + ".svg";
  ...
  //twentyjetsobj.find('.conf-jets-20').show();
