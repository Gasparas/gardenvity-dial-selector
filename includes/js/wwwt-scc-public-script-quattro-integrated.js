...
jQuery(document).ready(function ($) {
  const model = "Config Quattro Integrated"
  const ver = "v0.2";
  ...
  */
  ...
  function ChangeHeaterOrientation(type) {
    ...
    img.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-uk-heater-" + type + ".svg";
  }
  ...
  function CheckOverlapFilter(type_1, type_2) {
    if (dialSlotMemory.service[0] === dialSlotMemory.filter[0]) {
      ...
      if (currentServicePos != '6') {
        ...
        img.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-uk-service-" + 6 + ".svg";
        dialSlotMemory['service'].unshift('6');
        $('select[name="conf-service"]').val(6);
      } else {
        const img = document.querySelector('.conf-service');
        img.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-uk-service-" + 3 + ".svg";
  ...
  function CheckOverlap(type_1, type_2) {
    if (dialSlotMemory.service[0] === dialSlotMemory.filter[0]) {
      ...
      img_1.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-uk-" + type_1 + "-" + dialSlotMemory[type_2][0] + ".svg";
      $('select[name="conf-' + type_1 + '"]').val(dialSlotMemory[type_2][0]);

      const img_2 = document.querySelector('.conf-' + type_2);
      img_2.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-uk-" + type_2 + "-" + dialSlotMemory[type_1][1] + ".svg";
  ...
  function SwitchFilterBoxLayer(pos) {
    ...
    img.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-uk-filter-" + pos + ".svg";

    let element = $('select[name="conf-filter"]').val();
    /*if ( !restrictedServicePos.includes(element) ) {
  ...
  function SwitchServiceDoorLayer(pos) {
    // write DOM
    const img = document.querySelector('.conf-service');
    img.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-uk-service-" + pos + ".svg";
  ...
  function SwitchInsertLayer(color) {
    ...
    img.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-base-" + color + ".jpg";
    // write global var
  ...
  function SwitchAirJetsLayer(type) {
    ...
    img.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-air-jets-" + type + ".svg";
  ...
  function SwitchHydroJetsLayer(type, seats) {
    ...
    img.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-hydro-jets-" + type + "-" + seats + ".svg";
    // write ServiceDoor toggle
    if (type === 'none') {
  ...
  function SwitchLedLayer(type) {
    if (activeLeds[type] === 0) {
      ...
      img.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-led-" + type + ".svg";
      activeLeds[type] = 1;
      activeServiceDoorSystems[type] = 1;

    } else if (activeLeds[type] === 1) {
      const img = document.querySelector('.conf-led-' + type);
      img.src = "/wp-content/uploads/dial-selector-quattro-integrated/dial-selector-square-led-none.svg";
      activeLeds[type] = 0;
